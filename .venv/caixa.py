...
class Caixa(QWidget):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.setWindowTitle("Caixa da Americanas")
...
# =============================================================== CRIAÇÃO LAYOUTS ======================================================================================
        ...
        self.label_col_esquerda.setStyleSheet("QLabel{background-color:#C23D2F}")
        ...
        self.label_logo.setPixmap(QPixmap("Americanas.png"))
        ...
        self.label_col_direita.setStyleSheet("QLabel{background-color:#70231B}")
        ...
        cabecalho = ["Código", "Nome", "Quantidade", "Preço Unitário", "Sub Total"]
        # Definir a quqantidade de colunas da tabela
        self.tabela_produtos.setColumnCount(5)
        
        

        # Adicionar os itens do cabeçalho à tabela
        self.tabela_produtos.setHorizontalHeaderLabels(cabecalho)
        self.tabela_produtos.setStyleSheet("QTableWidget {font-size:15pt;color:background-color:#420100}")

        # Adicionar algumas linhas
        self.tabela_produtos.setRowCount(20)

        self.label_total_pagar = QLabel("Total a Pagar:")
        self.label_total_pagar.setStyleSheet("QLabel {font-size:30pt}")

        self.edit_total_pagar = QLineEdit("R$ 0,00")
        self.edit_total_pagar.setStyleSheet("QLineEdit {font-size:30pt})")
        self.edit_total_pagar.setEnabled(False)

        # Adicionar os controles ao layout vertical da coluna direita
...
# ================================================================== ADICIONAR OS LAYOUTS NA JANELA ==============================================================
    ...
    def keyPressEvent(self, event):
                # Verificar se a tecla pressionada é F3
        if event.key() == Qt.Key.Key_F3: 
        #    print("tecla f3 foi precionada")
             ...
             self.tabela_produtos.setItem(self.linha,4,QTableWidgetItem(self.edit_subtotal_produto.text()))
             self.linha+=1
             ...
             self.edit_subtotal_produto.setText("")
 

# Leite UHT Integral 70% Agua - Natural Eletrolux EA 360
# Suco de Tamarindo, que parece limão, com sabor de Laranja
